...
const COPY: Record<TokenLanguage, TokenCopy> = {
  id: {
    ...
    boardClosed: "Launchpad-nya belum ada di Robinhood Chain, jadi belum ada yang bisa dibaca.",
    reading: "Membaca dari chain…",
    unreachable: "Node-nya tidak menjawab, jadi tidak ada angka yang bisa ditampilkan.",
    mismatch:
  ...
  en: {
    ...
    boardClosed: "The launchpad has no contracts on Robinhood Chain yet, so there is nothing to read.",
    reading: "Reading from the chain…",
    unreachable: "The node did not answer, so there is nothing to show.",
