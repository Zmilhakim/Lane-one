...
import { LP_FEE, NATIVE } from "./constants";
 ...
 * checks it against the id and the price a real manager has — this file is a
 * copy of that one, taken with the rest of the launchpad's figures.
 */
